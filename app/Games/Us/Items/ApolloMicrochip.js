...
export default function(options) {
    var item = Object.assign({
        ...
        description: ["Enable a Rifle augment.", 'Add 0.25 hp to first aid pouch.'],
        ...
        plug: function() {
            this.owningUnit.firstAidPouchAdditions.push(0.25);
        },
        unplug: function() {
            mathArrayUtils.removeObjectFromArray(0.25, this.owningUnit.firstAidPouchAdditions);
        },
        plugTint: 0xffab08,
