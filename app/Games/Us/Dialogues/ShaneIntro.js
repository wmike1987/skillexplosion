...
var ShaneIntro = function(options) {
    ...
    this.createChain = function() {
        ...
        ds.push(new Dialogue({actor: "Shane",
            ...
            pauseAfterWord: [{word: 'intact...', duration: 100}],
            speedChangeAfterWord: {word: 'intact...', speed: 100},
            delayAfterEnd: 0}));
        ds.push(new Dialogue({actor: "MacMurray",
            interrupt: true,
        ...
        ds.push(new Dialogue({actor: "Shane",
            ...
            duration: 1300,
            pauseAfterWord: [{word: 'place?', duration: 700}, {word: 'bugs?', duration: 600}],
            delayAfterEnd: 350}));
        ds.push(new Dialogue({actor: "MacMurray",
            interrupt: true,
            speedChangeAfterWord: {word: 'not...', speed: 80},
            pauseAfterWord: {word: 'not...', duration: 500},
