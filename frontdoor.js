requirejs.config({
  ...
  paths: {
    ...
    matterCollisionPlugin:
      "https://cdn.jsdelivr.net/npm/matter-collision-events@0.1.7/build/matter-collision-events",
...
requirejs(["jquery"], function ($) {
  $(document).ready(function () {
    ...
    var loadGameIntoTheater = function (gameName) {
      ...
      //load game
      require([
        "core/CommonGameStarter",
        "games/" + gameName,
        "jquery",
        "utils/HS",
      ], function (GameStarter, game, $, hs) {
        ...
        if (game.instructions) {
          ...
          $.each(game.instructions, function (index, instruction) {
            $("#gameInstructions").append(
              "<div class='instructionBullet'>&bull;&nbsp;" +
                instruction +
                "</div>"
            );
          });
...
requirejs(["jquery", "pixi"], function ($, PIXI) {
  ...
  require(["pixi-spine", "pixi-layers"], function (spine, pixiLayers) {
    ...
    loader.add(
      ...
      "app/Textures/legacy/RainyBackgroundAndMarbles.json"
    );
    ...
    loader.add(
      "BaseUnitAnimations1",
      "app/Textures/Us/BaseUnitAnimations1.json"
    );
    ...
    loader.add(
      "BanelingAnimations1",
      "app/Textures/Us/BanelingAnimations1.json"
    );
